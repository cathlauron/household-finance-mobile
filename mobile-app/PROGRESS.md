...
- 8.2 — Travel checklist. ✅ Complete and confirmed working on a real phone, including real savings-goal auto-sync (tripFullChecklistTotal/syncTripSavingsGoal).
- 8.3 — Events + Year-End Goals. ✅ Complete and confirmed working on a real phone, including Events' own savings-goal auto-sync (syncEventSavingsGoal).
...
- Neither Travel nor Events converts a completed checklist item into an actual logged expense/transaction yet — both currently only sync a savings goal target, not a final transaction.
